...
<h1 class="cv-title">Experience.<br>Impact.<br>What’s Next.</h1>
...
<p class="cv-download-note">PDF • UPDATED SEPT 2026</p>
...
<p class="cv-sidebar-quote">
“Knowledge is a tool,<br>
but people are the<br>
purpose.”
</p>
...
<img src="images/overview-icon.png"
     class="cv-section-icon icon-overview"
     alt="Overview icon">
</div>
...
<img src="images/education-icon.png"
     class="cv-section-icon icon-education"
     alt="Education icon">
</div>
...
<img src="images/experience-icon.png"
     class="cv-section-icon icon-experience"
     alt="Public health experience icon">
</div>
...
<div class="cv-icon-wrap">
<img src="images/publications-icon.png"
     class="cv-section-icon icon-research"
     alt="Academic research and projects icon">
</div>
...
<div class="cv-icon-wrap">
<img src="images/leadership-icon.png"
     class="cv-section-icon icon-leadership"
     alt="Leadership and service icon">
</div>
...
<p class="cv-skill-label">LEADERSHIP & INVOLVEMENT</p>
...
<p class="cv-skill-label">COMMUNITY SERVICE</p>
...
<img src="images/skills-icon.png"
     class="cv-section-icon icon-skills"
     alt="Skills icon">
</div>
...
<div class="cv-icon-wrap">
<img src="images/references-icon.png"
     class="cv-section-icon icon-references"
     alt="References icon">
</div>
...
<a href="#cv-bottom"
  ...
  <span class="cv-scroll-arrow-icon">↓</span>
</a>